...
#define ARMA_SUPERLU_INCLUDE_DIR /opt/homebrew/include/
...
#define ARMA_AUX_LIBS -framework Accelerate;/opt/homebrew/lib/libarpack.dylib;/opt/homebrew/lib/libsuperlu.dylib
#define ARMA_AUX_INCDIRS /opt/homebrew/include
